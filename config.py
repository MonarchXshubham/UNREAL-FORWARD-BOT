...
class Config:
    ...
    DATABASE_URI = environ.get("DATABASE_URI", "DATABASE_URI", "mongodb+srv://madarazbotz:MJlmnDPtC63ihNK5@cluster0.7dxhb.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")
